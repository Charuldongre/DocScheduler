  ...
  return (
    <div className="flex bg-[#5f6fff] rounded-xl px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10">
        <div className='flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5'>
             <div className="text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold text-semibold text-white">
        ...
        <div className="hidden lg:block lg:w-1/2 lg:w-[137px] relative">
  <img
    className="absolute bottom-0 right-0 max-w-sm h-auto"
