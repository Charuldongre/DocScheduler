  ...
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-[#5f6fff] rounded-lg px-6 md:px-10 lg:px-20 '>
        ...
        <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]">
            <p className="text-3xl md:text-4xl lg:text-5xl text-white font-semibold">Book Appointment <br/> With Trusted Doctors</p>
        ...
        <div className='md:w-1/2 relative'>
            <img src={assets.header_img} alt="w-full md:absolute bottom-0 h-auto rounded-lg"/>
        </div>
    </div>
  )
}
